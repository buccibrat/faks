...
/**
 * Small demonstration of how <code>ArrayIndexedCollection</code> and
 * <code>LinkedlistIndexedCollection</code> could be used.
 * 
...
public class Main {
	/**
	 * Demonstrates adding, removing, printing and using forEach methods of
	 * <code>ArrayIndexedCollection</code> and
